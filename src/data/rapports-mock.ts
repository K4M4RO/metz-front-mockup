...
export const RAPPORT_PLAYERS: PlayerTarget[] = [
  ...
  // Enzo Millot — La cible prioritaire 🟢
  {
    id: "millot-01",
    name: "Millot",
    firstName: "Enzo",
    ...
    reports: [
      {
        ...
        note: "B",
        kanban: "identifie",
        comment: "Profil d'élite détecté. Très fort dans les petits espaces et la transition offensive. 88e percentile sur les passes clés en Bundesliga. Jeune talent français à rapatrier stratégiquement.",
      },
      {
        id: "r-em-02",
        date: "02 fév. 2025",
        ...
        note: "A",
        kanban: "analyse",
        comment: "Observation live contre Fribourg. Masterclass technique. Il dicte le tempo du match. Excellente capacité à casser les lignes par la passe ou le dribble. Défensivement très impliqué (6 ballons récupérés).",
        competition: "Bundesliga",
        affiche: "VfB Stuttgart vs Freiburg",
        poste: "MC",
        systeme: "4-2-3-1",
      },
      {
        ...
        note: "A",
        kanban: "valide",
        comment: "Validation totale. Contact établi avec l'entourage. Le joueur est séduit par le projet de hub data du FC Metz. Dossier complexe financièrement mais priorité absolue pour le renforcement du milieu.",
      },
    ],
  },
];
