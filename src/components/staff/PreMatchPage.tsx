...
type TabId = "summary" | "team-stats" | "players";
...
function ReportView({ match }: { match: typeof UPCOMING_MATCHES[0] }) {
  ...
  const tabs: { id: TabId; label: string }[] = [
    { id: "summary",    label: "Résumé + Formation" },
    { id: "team-stats", label: "Stats Équipe" },
  ...
  return (
    <div style={{ flex: 1, display: "flex", flexDirection: "column", minWidth: 0 }}>
      ...
      <div style={{ flex: 1 }}>
        ...
        {tab === "team-stats" && <TabTeamStats opponent={match.opponent} />}
